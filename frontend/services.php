    ...
    <div class="row title-bar">
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="#" class="list-group-item active">Tất cả thiết bị</a>
          <a href="#" class="list-group-item">Thiết bị thư viện</a>
          <a href="#" class="list-group-item">Dịch vụ phần mềm</a>
        </div>
      ...
      <div class="col-lg-9"> 
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card idt-history-card h-100">
              ...
              <div class="card-body text-center d-flex flex-column">
                ...
                <p class="customer-tag-row">KH: Hoàng Nam Moblie</p>
                
                <div class="warranty-details mt-auto">
                    <div class="date-row">Ngày mua: 10/01/2022</div>
                    <div class="date-row expired-text">Hết hạn: 10/01/2024</div>
                    <div class="duration-tag">Gói: 24 Tháng</div>
                </div>
                
                <div class="cart-icon text-center mt-2">
                  <a href="#" class="status-link expired">Gia hạn ngay</a>
                </div>
              </div>
            </div>
          </div> 
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card idt-history-card h-100">
              ...
              <div class="card-body text-center d-flex flex-column">
                ...
                <p class="customer-tag-row">KH: Cty Hải Nam</p>
                
                <div class="warranty-details mt-auto">
                    <div class="date-row">Ngày mua: 20/01/2024</div>
                    <div class="date-row active-text">Hết hạn: 20/01/2027</div>
                    <div class="duration-tag">Gói: 36 Tháng</div>
                </div>
                
                <div class="cart-icon text-center mt-2">
                  <a href="#" class="status-link">Đang bảo hành</a>
                </div>
              </div>
            </div>
          </div> 
